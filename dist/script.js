...
window.addEventListener("DOMContentLoaded", function () {
  ...
  feedSlider.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init(); // в Difference don't use super
...
function () {
  ...
  _createClass(Difference, [{
    key: "hideItems",
    value: function hideItems(hide) {
      hide.querySelectorAll(this.items).forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
    ...
    key: "bindTriggers",
    value: function bindTriggers(officer, items, container) {
      var _this = this;
      ...
      officer.querySelector('.plus').addEventListener('click', function () {
        if (container !== items.length - 2) {
          ...
          items[container].classList.add('slideInDown');
          items[container].style.display = 'flex';
          items[_this.newItems.length - 1].remove();
        }
      });
    }
  }, {
...
/*#__PURE__*/
function () {
  function VideoPlayer(btn, overlay, close) {
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, animate, autoplay, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, animate, autoplay, activeClass));
  }

  _createClass(MiniSlider, [{
    key: "decorazeSlides",
    value: function decorazeSlides() {
      var _this = this;
